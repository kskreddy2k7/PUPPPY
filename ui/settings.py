...
from puppy.achievements import ACHIEVEMENTS_LIST
...
class SettingsDialog(QDialog):
    def __init__(self, settings_manager, parent=None):
        ...
        self.setWindowTitle("Cute Puppy Settings & Profile")
        ...
        self.chk_autostart = QCheckBox("Start Cute Puppy with Windows")
        self.chk_autostart.setChecked(self.settings.get("start_with_windows", False))
        ...
        self.chk_sound.setChecked(self.settings.get("sound_enabled", False))
        f_snd.addRow(self.chk_sound)

        self.vol_slider = QSlider(Qt.Horizontal)
        self.vol_slider.setRange(0, 100)
        self.vol_slider.setValue(self.settings.get("sound_volume", 50))
