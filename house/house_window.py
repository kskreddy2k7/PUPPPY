...
ASSET_DAY = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "assets", "house", "house.png")
ASSET_NIGHT = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "assets", "house", "house_sleeping.png")
...
class HouseWindow(QWidget):
    ...
    def load_saved_position(self):
        ...
        if saved_x is not None and saved_y is not None and geom:
            # Check bounds to ensure home is visible on screen
