...
from puppy.sprite_generator import generate_all_assets

ASSETS_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "assets", "puppy")
...
class AnimationController:
    ...
    def __init__(self, settings_manager):
        ...
        # Storage: self.frames[state][facing_right_bool] = list of QPixmap
        self.frames = {}
    ...
    def load_all_sprites(self):
        ...
        for state, (folder, default_flip) in mapping.items():
            ...
            # Pre-cache pre-scaled and flipped variants
